	...
	{ soap = soap_new(); endpoint = "http://localhost:80"; if (soap && !soap->namespaces) { static const struct Namespace namespaces[] = 
{
	...
	/// Invoke 'tauschen' of service 'Service' and return error code (or SOAP_OK)
	virtual int adp_List__tauschen(std::string _param_1, std::string _param_2, std::string _param_3, int *_param_4) { return soap ? soap_call_adp_List__tauschen(soap, endpoint, NULL, _param_1, _param_2, _param_3, _param_4) : SOAP_EOM; };
};
#endif
